...
impl Gassmann {
    ...
    pub fn bulk_modulus(k_dry: f32, k_matrix: f32, k_fluid: f32, porosity: f32) -> f32 {
...
impl Dhi {
    ...
    pub fn score(vp_vs: f32, poisson: f32, intercept: f32, gradient: f32) -> f32 {
...
mod tests {
    ...
    fn test_bright_spot_probability() {
        ...
        assert!(
            prob > 0.8,
            "Strong bright spot should have high probability"
        );
    }
