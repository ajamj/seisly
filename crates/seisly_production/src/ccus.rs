...
impl CCUSMonitor {
    ...
    pub fn track_plume(&self, monitor_survey: Vec<f32>, dt: f32) -> PlumeMap {
        let analysis = TimeLapseAnalysis::new(self.baseline_survey.clone(), monitor_survey, dt);
